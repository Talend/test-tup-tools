...
public class PrepareBuilds {
	...
	public static void main(String[] args) throws IOException {
		// add for debug
				...
				System.setProperty("isNeed701License", "false");
				System.setProperty("isNeed711License", "false");
				System.setProperty("isNeed721License", "false");
	...
	public void generatP2() throws IOException {
		...
		if (Boolean.getBoolean("isNeedMixedLicense")) {
       	...
       	if (Boolean.getBoolean("isNeed701License")) {
			String licenseKey = System.getProperty("licenseKey");
			CommUtil.getAndDownloadReleaseLicense(ftpClient, localDestFileStr,Constants.Releaselicense701, tempFilePath, "licenses_701.zip",licenseKey);
		}
